...
import com.oops.gles.EglCore;
import com.oops.gles.GlUtil;
import com.oops.gles.LogUtils;
import com.oops.gles.WindowSurface;
...
public class VideoRenderer implements MediaPlayer.OnVideoSizeChangedListener,
    ...
    private BaseDrawer mEffectDrawer;
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        ...
        if (width < height) {
            ...
            float ratioHeight = (float) mSurfaceHeight / (float) mVideoHeight;
            mSurfaceWidth = (int) (ratioHeight * mVideoWidth);
    ...
    public void changeEffect(EffectType effectType) {
        switch (effectType) {
            case Mirror:
                mEffectDrawer = new MirrorDrawer(mContext, mOffscreenTextureID);
                break;
            case OldFilm:
                mEffectDrawer = new OldFilmDrawer(mContext, mOffscreenTextureID);
                break;
            case Gauss:
                mEffectDrawer = new BlurDrawer(mContext, mOffscreenTextureID);
                break;
            case NinePatch:
                mEffectDrawer = new NinePatchDrawer(mContext, mOffscreenTextureID);
                break;
            case ShockWave:
                mEffectDrawer = new ShockWaveDrawer(mContext, mOffscreenTextureID);
                break;
            case Vignette:
                mEffectDrawer = new VignetteDrawer(mContext, mOffscreenTextureID);
                break;
            case NightWalk:
                mEffectDrawer = new NightWalkDrawer(mContext, mOffscreenTextureID);
                break;
            case Lightning:
                mEffectDrawer = new LightningDrawer(mContext, mOffscreenTextureID);
                break;
            case Puppets:
                mEffectDrawer = new PuppetsDrawer(mContext, mOffscreenTextureID);
                break;
            case Shake:
                mEffectDrawer = new ShakeDrawer(mContext, mOffscreenTextureID);
                break;
        }
        mEffectDrawer.updateProjection(mSurfaceWidth, mSurfaceHeight, mVideoWidth, mVideoHeight);
        mEffectDrawer.startRender();
    }
}